...
def object_track(predict_json, ns, state_q=None, is_5m=None, is_open=None, is_indoor=False, is_outdoor=False):
    """
    ...
    # curr_frame = YoloFrame(predict_result, obj_filter=ball_filter)
    ...
    if prev_frame.__dict__:
        ...
        for i, obj in enumerate(curr_frame.objects):
            ...
            # Cast stay time
            if obj.state.stay_time > obj.state.notify_time and state_q is not None:
